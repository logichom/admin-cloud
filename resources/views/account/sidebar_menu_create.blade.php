...
@section('content')
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">新增目錄</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <form action="{{ route('sidebar_menu_create') }}" method="post">
      @csrf
      <div class="row">
        <div class="col-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="number" id="seq" name="seq" class="form-control" value="{{ old('seq') }}">
              </div>
              @if ($errors->any())
      ...
      <div class="row">
        <div class="col-12">
          <a href="{{ route('sidebar_menu') }}" class="btn btn-secondary">取消</a>
